...
import brcomdio.util.BoardTemplate;
...
public class Main {
    ...
    private static void startGame(final Map<String, String> positions){
        if (nonNull(board)) {
            System.out.println("O jogo vai foi iniciado");
            return;
        }
    ...
    private static void inputNumber(){
        ...
        System.out.printf("\n Informe o numero que vai entrar na posição [%s,%s]\n", col, row);
    ...
    private static void showCurrentGame(){
        ...
        System.out.println("Seu jogo se encontra da seguindo forma: ");
    ...
    private static void clearGame(){
        ...
        System.out.println("Tem certeza que desejar limpar? ");
    ...
    private static void finishGame(){
        ...
        if (board.gameIsFished()) {
            System.out.println("Parabens, jogo concluido");
            showCurrentGame();
            board = null;
        }
        else if (board.hasErrors()) {
            System.out.println("Seu jogo ainda contem erros. Verifique seu board novamente.");
        }
        else
            System.out.println("Precisa preencher todos os espaços.");
    }
